...
(define (problem do-heist)
  ...
  (:objects ;; People
            ...
            blue-dress - valuable
            poker-game-obj - poker-game)
  (:init ;; Map
         (connected bank-obj main-street)
         (connected main-street bank-obj)
         ...
         (connected bank-obj out-of-town)
         ;; Where things are.
         (has bank-obj mother-lode-obj)
         (has bank-obj dress-money)
         (has barney six-shooter)
         (has horse-seller brown-horse)
         (has tom white-horse)
         (at white-horse barber-shop)
         (has pawn-broker-obj locket-money)
         (has robbie locket)
         (at handcuffs sheriffs-office)
         (has sally tomatoes)
         (has anne tomato-money)
         (forsale blue-dress general-store)
         (at poker-game-obj saloon)
         (bet-at poker-money poker-game-obj)
         ;; Locations
         ...
         (at pawn-broker-obj main-street)
         (at jill general-store)
         (at anne main-street)
         (at child main-street)
         ;; Misc.
         (guard-of barney bank-obj)
  ...
  (:goal (and 
    (exists (?sheriff - sheriff ?character - character) (arrested ?sheriff ?character))
