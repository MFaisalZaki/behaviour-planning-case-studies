...
class InstantaneousAction(Action):
    ...
    def __init__(
        ...
        **kwargs: "up.model.types.Type",
        ...
        self._fails:  List["up.model.fnode.FNode"] = []
        self._actors: List["up.model.fnode.FNode"] = []
    ...
    def clone(self):
        ...
        new_instantaneous_action._fails = self._fails.copy()
        new_instantaneous_action._actors = self._actors.copy()
    ...
    def add_fail(self,
        ...
        self._add_fail_instance(
            up.model.effect.Effect(fluent_exp, value_exp, condition_exp, forall=forall)
        )
    
    def _add_fail_instance(self, effect: "up.model.effect.Effect"):
        assert (
    ...
    def add_agent(
        ...
        # add the agent and its index based on its position in the parameters list.
        if agent not in self._actors:
            self._actors.extend(filter(lambda e: str(agent) == e[1].name, enumerate(self.parameters)))
