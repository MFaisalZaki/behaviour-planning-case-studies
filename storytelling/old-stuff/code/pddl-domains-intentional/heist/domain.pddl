...
(define (domain heist)
  ...
  (:action hatch-plan
    ...
    :effect       (and (not (has ?character ?mother-lode))
                       (intends ?character (has ?character ?gun))
                       (intends ?character (has ?character ?horse))
                       (intends ?character (has ?character ?mother-lode))
                       (intends ?character (free-with-money ?character))))
  ...
  (:action hold-up-bank
    ...
    :effect       (and (held-up ?character ?bank)
                       (intends ?sheriff (arrested ?sheriff ?character)))
    )
